...
export class ReportComponent implements OnInit {
  ...
  getChart() {
    let chart = am4core.create("trackreportchartdiv", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("trackreportchartdiv1", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("trackreportchartdiv3", am4charts.XYChart);
